    ...
    public:
            ...
            : enable_formatting_ { enable_formatting }
        {
            ...
            if (::setvbuf(journal_, nullptr, _IOLBF, 0) != 0) {
                ...
                ::close(stream_fd);
                throw_spdlog_ex(
                    "Failed setting line buffering mode for systemd journal stream to namespace '" + name_space + "'",
                    saved_errno);
            }
        }
    ...
    protected:
        ...
        void sink_it_(const details::log_msg& msg) override
        {
            ...
            while (pos < payload.size()) {
                ...
                const auto& prefix = level_prefixes_.at(static_cast<level_prefix_array::size_type>(msg.level));
